...
Update documentation based on codebase changes using the SDE2 agent.

## Agent Used

| Agent | Skill | Purpose |
| --- | --- | --- |
| [SDE2](../agents/sde2.md) | [update-docs-guide](../skills/update-docs-guide/SKILL.md) | Keep docs accurate and complete |
