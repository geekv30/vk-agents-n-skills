...
Analyze dependencies for updates, breaking changes, deprecations, and migration paths using the SDE2 agent.

## Agent Used

| Agent | Skill | Purpose |
| --- | --- | --- |
| [SDE2](../agents/sde2.md) | [analyze-deps-guide](../skills/analyze-deps-guide/SKILL.md) | Dependency analysis report |
