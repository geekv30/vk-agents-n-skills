...
```
Examples:
  /test                              -> Use conversation context
  /test ./docs/TESTING_PLAN.md       -> Follow testing plan
  /test #42                          -> Fetch from GitHub issue
  /test src/module.ts                -> Write tests for module
  /test "tests for search pipeline"  -> Description
```
...
```
Detect Context -> Spawn Tester Agent -> Report
```
