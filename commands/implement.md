...
### Phase 3: Brainstorm (Superpowers Plugin)

Before planning, invoke the `superpowers:brainstorming` skill to explore intent, requirements, and design considerations. This ensures the architect gets well-thought-out input rather than raw requirements.

```
Skill("superpowers:brainstorming")
```

Follow the brainstorming process, then pass the refined understanding to the architect.

### Phase 4: Architect Planning
...
### Phase 7: Verification (Superpowers Plugin)
...
Run typecheck, lint, and any relevant tests. Confirm all pass before proceeding to the report. **Evidence before assertions.**

### Phase 8: Report

After all tasks are done and verification passes:
